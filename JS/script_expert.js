window.onload = function() 
{
    ...
    function intro() //Valide le pseudo et creation de la trame de jeu
    {
        ...
        audio.play();
        const welcome="<p><strong>Mode Expert:</strong> Tu as <b>"
                    +count
                    +"</b> vies par niveau!</p>";
        ...
        else
        {
            ...
            else
            {
                ...
                if (tableau[countConstante - count] == hasard && count > 0) 
                {
                    ...
                    const bravo2="Bravo! Tu as reussi tous les niveaux"
                                +"\net tous les modes de difficulté,"
                                +"\nen "
                                +"<strong>"+(dateFin.getMinutes()-dateDebut.getMinutes())+"</strong>"
                                +" minutes."
                                +"\n<strong>Ce jeu n'est plus mysterieux pour toi!</strong>";
    ...
    //-------------------------------------------------------------------------------------------
        ...
        if (tableau[countConstante - count] < hasard) 
        {
            ...
            if (diff > 9)
                ...
                {document.querySelector("#plusMoins img").src = 'img/presque.gif';}
