window.onload = function() 
{
    ...
    let count = 6; //nombre de vie au debut du jeu
    const countConstante = count;
    const tableau = [];
    const difficult = [75,100,125,150];
    let niveau=0;
    let succes=false;
    ...
    function intro() //Valide le pseudo et creation de la trame de jeu
    {
        ...
        audio.play();
        const welcome="<p><strong>Mode Moyen:</strong> Tu as <b>"
                    +count
                    +"</b> vies par niveau!</p>";
        ...
        else
        {
            ...
            else
            {
                ...
                if (tableau[countConstante - count] == hasard && count > 0) 
                {
                    ...
                    const bravo2="Bravo!\nTu as reussi tous les niveaux du mode <strong>Moyen!!!</strong>"
                                +"\nEn "
    ...
    //-------------------Gestion du bouton changer de niveau/rejouer-----------------------------
                    ...
                    else
                    {
                        ...
                        idBouton3.textContent="Niveau Expert";
                        idBouton3.style.visibility = "visible";
                    }
